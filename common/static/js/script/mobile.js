...
$(document).ready(function(){
    ...
    $.ajax({
        ...
        for(var i = 0; i < data.length; i++){
            ...
            if(data[i][5] == 1){
                html += "<span class='title'><a href='/comm_mobile_view/"+data[i][4]+"'>"+data[i][6]+data[i][1]+" <img src='/static/images/new.jpeg' height='15px;'></a></span>";
            }else{
                html += "<span class='title'><a href='/comm_mobile_view/"+data[i][4]+"'>"+data[i][6]+data[i][1]+"</a></span>";
            }
