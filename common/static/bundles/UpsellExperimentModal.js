...
/***/ "./common/static/common/js/components/ExperimentalCarousel.jsx":
...
function NextArrow(props) {
  var currentSlide = props.currentSlide,
      ...
      displayedSlides = props.displayedSlides;

  var showArrow = slideCount - currentSlide > displayedSlides;
  var opts = {
    className: __WEBPACK_IMPORTED_MODULE_2_classnames___default()('js-carousel-nav', 'carousel-arrow', 'next', 'btn btn-secondary', { 'active': showArrow }),
    onClick: onClick
  };
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', { className: 'icon fa fa-chevron-right', 'aria-hidden': 'true' }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'span',
      { className: 'sr' },
...
function PrevArrow(props) {
  ...
  var showArrow = currentSlide > 0;
  var opts = {
    className: __WEBPACK_IMPORTED_MODULE_2_classnames___default()('js-carousel-nav', 'carousel-arrow', 'prev', 'btn btn-secondary', { 'active': showArrow }),
    onClick: onClick
  };
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'button',
    opts,
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', { className: 'icon fa fa-chevron-left', 'aria-hidden': 'true' }),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'span',
      null,
      ' Prev'
...
var ExperimentalCarousel = function (_React$Component) {
  _inherits(ExperimentalCarousel, _React$Component);

  function ExperimentalCarousel(props) {
    _classCallCheck(this, ExperimentalCarousel);

    var _this = _possibleConstructorReturn(this, (ExperimentalCarousel.__proto__ || Object.getPrototypeOf(ExperimentalCarousel)).call(this, props));
    ...
    _this.getCarouselContent = _this.getCarouselContent.bind(_this);
    return _this;
  }

  _createClass(ExperimentalCarousel, [{
    key: 'afterChange',
    value: function afterChange(activeIndex) {
    ...
    value: function getCarouselContent() {
      ...
      return this.props.slides.map(function (slide, i) {
        var firstIndex = _this2.state.activeIndex || 0;
        var lastIndex = firstIndex + _this2.props.slides.length;
        var tabIndex = firstIndex <= i && i < lastIndex ? undefined : '-1';
        var carouselLinkProps = {
          ref: function ref(item) {
            _this2.carousels[i] = item;
          },
          tabIndex: tabIndex,
    ...
    value: function render() {
      var carouselSettings = {
        ...
        nextArrow: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(NextArrow, { displayedSlides: 1 }),
        prevArrow: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(PrevArrow, null),
  ...
  return ExperimentalCarousel;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

/* harmony default export */ __webpack_exports__["a"] = (ExperimentalCarousel);


ExperimentalCarousel.propTypes = {
  slides: __WEBPACK_IMPORTED_MODULE_3_prop_types___default.a.array.isRequired
};
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UpsellExperimentModal", function() { return UpsellExperimentModal; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ExperimentalCarousel_jsx__ = __webpack_require__("./common/static/common/js/components/ExperimentalCarousel.jsx");
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var UpsellExperimentModal = function (_React$Component) {
    _inherits(UpsellExperimentModal, _React$Component);

    function UpsellExperimentModal(props) {
        _classCallCheck(this, UpsellExperimentModal);

        var _this = _possibleConstructorReturn(this, (UpsellExperimentModal.__proto__ || Object.getPrototypeOf(UpsellExperimentModal)).call(this, props));
    ...
    _createClass(UpsellExperimentModal, [{
        key: 'render',
        value: function render() {
            var slides = [__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'my-stats-introduction' },
                    'My Stats introduces new personalized views that help you track your progress towards completing your course!'
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'my-stats-slide-header' },
                    'With My Stats you will see your:'
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'ul',
                    { className: 'upsell-modal-checkmark-group' },
                    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                        'li',
                        null,
                        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', { className: 'fa fa-check upsell-modal-checkmark', 'aria-hidden': 'true' }),
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'span',
                    { className: 'course-activity-streak-information' },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'span',
                    { className: 'grade-progress-information' },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'span',
                    { className: 'discussion-engagements-information' },
            ...
            var body = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                null,
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__ExperimentalCarousel_jsx__["a" /* default */], { id: 'upsell-modal', slides: slides }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', {
            ...
            var buttonDestinationURL = this.props.buttonDestinationURL;

            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__edx_paragon_static__["Modal"], {
                ...
                buttons: [__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__edx_paragon_static__["Button"], {
                    ...
                    , onClick: function onClick() {
                        return window.location = buttonDestinationURL;
                    }
                })]
            });
        }
    ...
    return UpsellExperimentModal;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);

UpsellExperimentModal.propTypes = {
    buttonDestinationURL: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired
};
...
var _helpers = __webpack_require__("./node_modules/react-slick/lib/mixins/helpers.js");
...
module.exports = __webpack_require__("./node_modules/react-slick/lib/slider.js");
...
var _eventHandlers = __webpack_require__("./node_modules/react-slick/lib/mixins/event-handlers.js");
...
var _trackHelper = __webpack_require__("./node_modules/react-slick/lib/mixins/trackHelper.js");
...
var enquire = _canUseDom2.default && __webpack_require__("./node_modules/enquire.js/src/index.js");
...
//# sourceMappingURL=UpsellExperimentModal.js.map