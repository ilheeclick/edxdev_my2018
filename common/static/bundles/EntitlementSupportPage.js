...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/components/EntitlementForm/container.jsx":
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_actions_entitlement__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/entitlement.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_actions_form__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/form.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__index_jsx__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/EntitlementForm/index.jsx");
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    createEntitlement: function createEntitlement(_ref) {
      var username = _ref.username,
          courseUuid = _ref.courseUuid,
          mode = _ref.mode,
          comments = _ref.comments;
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__data_actions_entitlement__["b" /* createEntitlement */])({ username: username, courseUuid: courseUuid, mode: mode, comments: comments }));
    },
    reissueEntitlement: function reissueEntitlement(_ref2) {
      var entitlement = _ref2.entitlement,
          comments = _ref2.comments;
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__data_actions_entitlement__["c" /* reissueEntitlement */])({ entitlement: entitlement, comments: comments }));
    },
    closeForm: function closeForm() {
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__data_actions_form__["c" /* closeForm */])());
    }
  };
};

var EntitlementFormContainer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(__WEBPACK_IMPORTED_MODULE_3__index_jsx__["a" /* default */]);

/* harmony default export */ __webpack_exports__["a"] = (EntitlementFormContainer);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__data_constants_formTypes__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/constants/formTypes.js");
...
var EntitlementForm = function (_React$Component) {
  _inherits(EntitlementForm, _React$Component);

  function EntitlementForm(props) {
    _classCallCheck(this, EntitlementForm);

    var _this = _possibleConstructorReturn(this, (EntitlementForm.__proto__ || Object.getPrototypeOf(EntitlementForm)).call(this, props));

    if (props.formType === __WEBPACK_IMPORTED_MODULE_3__data_constants_formTypes__["a" /* formTypes */].REISSUE) {
      var _props$entitlement = props.entitlement,
          courseUuid = _props$entitlement.courseUuid,
          mode = _props$entitlement.mode,
          user = _props$entitlement.user;
    ...
    _this.handleCourseUUIDChange = _this.handleCourseUUIDChange.bind(_this);
  ...
  _createClass(EntitlementForm, [{
    key: 'onClose',
    value: function onClose() {
      this.props.closeForm();
    }
  }, {
    key: 'handleCourseUUIDChange',
    value: function handleCourseUUIDChange(courseUuid) {
      this.setState({ courseUuid: courseUuid });
    }
  }, {
    ...
    value: function handleCommentsChange(comments) {
    ...
    value: function submitForm() {
      var _state = this.state,
          courseUuid = _state.courseUuid,
          username = _state.username,
          mode = _state.mode,
          comments = _state.comments;
      var _props = this.props,
          formType = _props.formType,
          entitlement = _props.entitlement;

      if (formType === __WEBPACK_IMPORTED_MODULE_3__data_constants_formTypes__["a" /* formTypes */].REISSUE) {
        // if there is an active entitlement we are updating an entitlement
        this.props.reissueEntitlement({ entitlement: entitlement, comments: comments });
      } else {
        // if there is no active entitlement we are creating a new entitlement
        this.props.createEntitlement({ courseUuid: courseUuid, username: username, mode: mode, comments: comments });
      }
    }
  }, {
    key: 'render',
    value: function render() {
      var _state2 = this.state,
          courseUuid = _state2.courseUuid,
          username = _state2.username,
          mode = _state2.mode,
          comments = _state2.comments;

      var isReissue = this.props.formType === __WEBPACK_IMPORTED_MODULE_3__data_constants_formTypes__["a" /* formTypes */].REISSUE;
      var title = isReissue ? 'Re-issue Entitlement' : 'Create Entitlement';

      var body = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        null,
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__edx_paragon__["InputSelect"], {
          ...
          label: 'Mode',
          value: mode,
          options: [{ label: '--', value: '' }, { label: 'Verified', value: 'verified' }, { label: 'Professional', value: 'professional' }, { label: 'No ID Professional', value: 'no-id-professional' }],
          onChange: this.handleModeChange
        }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__edx_paragon__["TextArea"], {
          name: 'comments',
          label: 'Comments',
          value: comments,
...
EntitlementForm.propTypes = {
  formType: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
  isOpen: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool.isRequired,
  entitlement: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
    uuid: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
    courseUuid: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
    created: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
    modified: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
    expiredAt: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
    mode: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
    orderNumber: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
    supportDetails: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.shape({
      supportUser: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
      action: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
      comments: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string,
      unenrolledRun: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string
    })),
    user: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired
  }),
  createEntitlement: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired,
  reissueEntitlement: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired,
  closeForm: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired
};
...
/* harmony default export */ __webpack_exports__["a"] = (EntitlementForm);

/***/ }),

/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/components/Main/Main.jsx":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edx_paragon__ = __webpack_require__("./node_modules/@edx/paragon/themeable/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edx_paragon___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__edx_paragon__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Search_SearchContainer_jsx__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/Search/SearchContainer.jsx");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Table_EntitlementSupportTableContainer_jsx__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/Table/EntitlementSupportTableContainer.jsx");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__EntitlementForm_container_jsx__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/EntitlementForm/container.jsx");
...
var Main = function Main(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'div',
    { className: 'entitlement-support-wrapper' },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__edx_paragon__["StatusAlert"], {
      alertType: 'danger',
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(MainContent, {
...
var MainContent = function MainContent(props) {
  if (props.isFormOpen) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__EntitlementForm_container_jsx__["a" /* default */], null);
  }
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    'div',
    null,
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'actions' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Search_SearchContainer_jsx__["a" /* default */], null),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__edx_paragon__["Button"], {
        className: ['btn', 'btn-primary'],
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Table_EntitlementSupportTableContainer_jsx__["a" /* default */], { ecommerceUrl: props.ecommerceUrl })
  );
};

Main.propTypes = {
  errorMessage: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
  dismissErrorMessage: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired,
  openCreationForm: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.func.isRequired,
  ecommerceUrl: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string.isRequired,
  isFormOpen: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.bool.isRequired
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_redux__ = __webpack_require__("./node_modules/react-redux/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_actions_error__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/error.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_actions_form__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/form.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Main_jsx__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/Main/Main.jsx");
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    dismissErrorMessage: function dismissErrorMessage() {
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__data_actions_error__["a" /* dismissError */])());
    },
    openCreationForm: function openCreationForm() {
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__data_actions_form__["a" /* openCreationForm */])());
    }
  };
};

var MainContainer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(__WEBPACK_IMPORTED_MODULE_3__Main_jsx__["a" /* default */]);

/* harmony default export */ __webpack_exports__["a"] = (MainContainer);

/***/ }),

/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/components/Search/Search.jsx":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__edx_paragon__ = __webpack_require__("./node_modules/@edx/paragon/themeable/index.js");
...
var Search = function (_React$Component) {
  ...
  _createClass(Search, [{
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'form',
        { onSubmit: this.handleSubmit, className: 'col-md-3 search-form' },
...
Search.propTypes = {
  fetchEntitlements: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func.isRequired
};
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/components/Search/SearchContainer.jsx":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_redux__ = __webpack_require__("./node_modules/react-redux/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_actions_entitlement__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/entitlement.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Search_jsx__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/Search/Search.jsx");
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    fetchEntitlements: function fetchEntitlements(username) {
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__data_actions_entitlement__["a" /* fetchEntitlements */])(username));
    }
  };
};

var SearchContainer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(__WEBPACK_IMPORTED_MODULE_2__Search_jsx__["a" /* default */]);

/* harmony default export */ __webpack_exports__["a"] = (SearchContainer);

/***/ }),

/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/components/Table/EntitlementSupportTable.jsx":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__("./node_modules/prop-types/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__edx_paragon__ = __webpack_require__("./node_modules/@edx/paragon/themeable/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__edx_paragon___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__);
...
var parseEntitlementData = function parseEntitlementData(entitlements, ecommerceUrl, openReissueForm) {
  return entitlements.map(function (entitlement) {
    var expiredAt = entitlement.expiredAt,
    ...
    return _extends({}, entitlement, {
      expiredAt: expiredAt ? __WEBPACK_IMPORTED_MODULE_1_moment___default()(expiredAt).format('lll') : '',
      createdAt: __WEBPACK_IMPORTED_MODULE_1_moment___default()(created).format('lll'),
      modifiedAt: __WEBPACK_IMPORTED_MODULE_1_moment___default()(modified).format('lll'),
      orderNumber: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["Hyperlink"], {
        destination: '' + ecommerceUrl + orderNumber + '/',
        content: orderNumber || ''
      }),
      button: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["Button"], {
        disabled: !enrollmentCourseRun,
        className: ['btn', 'btn-primary'],
        label: 'Reissue',
        onClick: function onClick() {
          return openReissueForm(entitlement);
        }
      })
    });
  });
...
var EntitlementSupportTable = function EntitlementSupportTable(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["Table"], {
...
EntitlementSupportTable.propTypes = {
  entitlements: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.shape({
    uuid: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired,
    courseUuid: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired,
    enrollmentCourseRun: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
    created: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired,
    modified: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired,
    expiredAt: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
    mode: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired,
    orderNumber: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
    supportDetails: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.shape({
      supportUser: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
      action: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
      comments: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string,
      unenrolledRun: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string
    })),
    user: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired
  })).isRequired,
  ecommerceUrl: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.string.isRequired,
  openReissueForm: __WEBPACK_IMPORTED_MODULE_2_prop_types___default.a.func.isRequired
};

/* harmony default export */ __webpack_exports__["a"] = (EntitlementSupportTable);

/***/ }),

/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/components/Table/EntitlementSupportTableContainer.jsx":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_redux__ = __webpack_require__("./node_modules/react-redux/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_actions_form__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/form.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__EntitlementSupportTable_jsx__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/Table/EntitlementSupportTable.jsx");
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
  return {
    openReissueForm: function openReissueForm(entitlement) {
      return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__data_actions_form__["b" /* openReissueForm */])(entitlement));
    }
  };
};

var EntitlementSupportTableContainer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react_redux__["b" /* connect */])(mapStateToProps, mapDispatchToProps)(__WEBPACK_IMPORTED_MODULE_2__EntitlementSupportTable_jsx__["a" /* default */]);

/* harmony default export */ __webpack_exports__["a"] = (EntitlementSupportTableContainer);

/***/ }),

/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/entitlement.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return fetchEntitlements; });
/* unused harmony export fetchEntitlementsSuccess */
/* unused harmony export fetchEntitlementsFailure */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return createEntitlement; });
/* unused harmony export createEntitlementSuccess */
/* unused harmony export createEntitlementFailure */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return reissueEntitlement; });
/* unused harmony export reissueEntitlementSuccess */
/* unused harmony export reissueEntitlementFailure */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_camelize__ = __webpack_require__("./node_modules/camelize/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_camelize___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_camelize__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__api_client__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/api/client.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__constants_actionTypes__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/constants/actionTypes.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__error__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/error.js");
...
var fetchEntitlementsSuccess = function fetchEntitlementsSuccess(entitlements) {
  return {
    type: __WEBPACK_IMPORTED_MODULE_2__constants_actionTypes__["b" /* entitlementActions */].fetch.SUCCESS,
    entitlements: entitlements
  };
};

var fetchEntitlementsFailure = function fetchEntitlementsFailure(error) {
  return function (dispatch) {
    return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__error__["b" /* displayError */])('Error Getting Entitlements', error));
  };
};

var fetchEntitlements = function fetchEntitlements(username) {
  return function (dispatch) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_client__["a" /* getEntitlements */])(username).then(function (response) {
      if (response.ok) {
        return response.json();
      }
      throw new Error(response);
    }).then(function (json) {
      return dispatch(fetchEntitlementsSuccess(__WEBPACK_IMPORTED_MODULE_0_camelize___default()(json.results)));
    }, function (error) {
...
var reissueEntitlementSuccess = function reissueEntitlementSuccess(entitlement) {
  return {
    type: __WEBPACK_IMPORTED_MODULE_2__constants_actionTypes__["b" /* entitlementActions */].reissue.SUCCESS,
    entitlement: entitlement
  };
};

var reissueEntitlementFailure = function reissueEntitlementFailure(error) {
  return function (dispatch) {
    return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__error__["b" /* displayError */])('Error Reissuing Entitlement', error));
  };
};

var reissueEntitlement = function reissueEntitlement(_ref) {
  var entitlement = _ref.entitlement,
      comments = _ref.comments;
  return function (dispatch) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_client__["b" /* patchEntitlement */])({
      ...
      return dispatch(reissueEntitlementSuccess(__WEBPACK_IMPORTED_MODULE_0_camelize___default()(json)));
    }, function (error) {
      return dispatch(reissueEntitlementFailure(error));
    });
  };
};

var createEntitlementSuccess = function createEntitlementSuccess(entitlement) {
  return {
    type: __WEBPACK_IMPORTED_MODULE_2__constants_actionTypes__["b" /* entitlementActions */].create.SUCCESS,
    entitlement: entitlement
  };
};

var createEntitlementFailure = function createEntitlementFailure(error) {
  return function (dispatch) {
    return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__error__["b" /* displayError */])('Error Creating Entitlement', error));
  };
};

var createEntitlement = function createEntitlement(_ref2) {
  var username = _ref2.username,
      courseUuid = _ref2.courseUuid,
      mode = _ref2.mode,
      comments = _ref2.comments;
  return function (dispatch) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_client__["c" /* postEntitlement */])({
      username: username,
      courseUuid: courseUuid,
      mode: mode,
      comments: comments,
      ...
      return dispatch(createEntitlementSuccess(__WEBPACK_IMPORTED_MODULE_0_camelize___default()(json)));
    }, function (error) {
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/error.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return displayError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return dismissError; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/constants/actionTypes.js");


var displayError = function displayError(message, error) {
  return {
    type: __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["c" /* errorActions */].DISPLAY_ERROR,
    error: message + ': ' + error
  };
};
...
var dismissError = function dismissError() {
  return {
    type: __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["c" /* errorActions */].DISMISS_ERROR
  };
};
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/actions/form.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return openReissueForm; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return openCreationForm; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return closeForm; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/constants/actionTypes.js");


var openReissueForm = function openReissueForm(entitlement) {
  return {
    type: __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* formActions */].OPEN_REISSUE_FORM,
    entitlement: entitlement
  };
};

var openCreationForm = function openCreationForm() {
  return {
    type: __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* formActions */].OPEN_CREATION_FORM
  };
};

var closeForm = function closeForm() {
  return {
    type: __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* formActions */].CLOSE_FORM
  };
};
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/api/client.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return getEntitlements; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return postEntitlement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return patchEntitlement; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__endpoints__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/api/endpoints.js");
...
var getEntitlements = function getEntitlements(username) {
  return fetch(__WEBPACK_IMPORTED_MODULE_2__endpoints__["a" /* entitlementApi */] + '?user=' + username, {
    credentials: 'same-origin',
    method: 'get'
  });
};

var postEntitlement = function postEntitlement(_ref) {
  var username = _ref.username,
      courseUuid = _ref.courseUuid,
      mode = _ref.mode,
      action = _ref.action,
      _ref$comments = _ref.comments,
      comments = _ref$comments === undefined ? null : _ref$comments;
  return fetch('' + __WEBPACK_IMPORTED_MODULE_2__endpoints__["a" /* entitlementApi */], {
    credentials: 'same-origin',
    method: 'post',
    headers: HEADERS,
    body: JSON.stringify({
...
var patchEntitlement = function patchEntitlement(_ref2) {
  var uuid = _ref2.uuid,
      action = _ref2.action,
      _ref2$unenrolledRun = _ref2.unenrolledRun,
      unenrolledRun = _ref2$unenrolledRun === undefined ? null : _ref2$unenrolledRun,
      _ref2$comments = _ref2.comments,
      comments = _ref2$comments === undefined ? null : _ref2$comments;
  return fetch('' + __WEBPACK_IMPORTED_MODULE_2__endpoints__["a" /* entitlementApi */] + uuid, {
    credentials: 'same-origin',
    method: 'patch',
    headers: HEADERS,
    body: JSON.stringify({
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/api/endpoints.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return entitlementApi; });
var entitlementApi = '/api/entitlements/v1/entitlements/';



/***/ }),

/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/constants/actionTypes.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return entitlementActions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return errorActions; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return formActions; });
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/constants/formTypes.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return formTypes; });
var formTypes = {
  REISSUE: 'reissue',
  CREATE: 'create'
};
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/reducers/entitlements.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var entitlements = function entitlements() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
  var action = arguments[1];

  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["b" /* entitlementActions */].fetch.SUCCESS:
      return action.entitlements;
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["b" /* entitlementActions */].create.SUCCESS:
      return [].concat(_toConsumableArray(state), [action.entitlement]);
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["b" /* entitlementActions */].reissue.SUCCESS:
      return state.map(function (entitlement) {
...
/* harmony default export */ __webpack_exports__["a"] = (entitlements);

/***/ }),

/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/reducers/error.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var error = function error() {
  ...
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["c" /* errorActions */].DISPLAY_ERROR:
      return action.error;
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["c" /* errorActions */].DISMISS_ERROR:
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["b" /* entitlementActions */].fetch.SUCCESS:
      return '';
    default:
      return state;
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/reducers/form.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/constants/actionTypes.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__constants_formTypes__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/constants/formTypes.js");
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var form = function form() {
  ...
  switch (action.type) {
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* formActions */].OPEN_REISSUE_FORM:
      return _extends({}, state, { formType: __WEBPACK_IMPORTED_MODULE_1__constants_formTypes__["a" /* formTypes */].REISSUE, isOpen: true, activeEntitlement: action.entitlement });
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* formActions */].OPEN_CREATION_FORM:
      return _extends({}, state, { formType: __WEBPACK_IMPORTED_MODULE_1__constants_formTypes__["a" /* formTypes */].CREATE, isOpen: true, activeEntitlement: null });
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["a" /* formActions */].CLOSE_FORM:
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["b" /* entitlementActions */].reissue.SUCCESS:
    case __WEBPACK_IMPORTED_MODULE_0__constants_actionTypes__["b" /* entitlementActions */].create.SUCCESS:
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/reducers/index.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_redux__ = __webpack_require__("./node_modules/redux/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__entitlements__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/reducers/entitlements.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__error__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/reducers/error.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__form__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/reducers/form.js");
...
var rootReducer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux__["d" /* combineReducers */])({ entitlements: __WEBPACK_IMPORTED_MODULE_1__entitlements__["a" /* default */], error: __WEBPACK_IMPORTED_MODULE_2__error__["a" /* default */], form: __WEBPACK_IMPORTED_MODULE_3__form__["a" /* default */] });

/* harmony default export */ __webpack_exports__["a"] = (rootReducer);

/***/ }),

/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/data/store.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reducers_index__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/reducers/index.js");
...
var configureStore = function configureStore(initialState) {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* createStore */])(__WEBPACK_IMPORTED_MODULE_2__reducers_index__["a" /* default */], initialState, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_redux__["c" /* applyMiddleware */])(__WEBPACK_IMPORTED_MODULE_1_redux_thunk___default.a));
};
...
/***/ "./lms/djangoapps/support/static/support/jsx/entitlements/index.jsx":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EntitlementSupportPage", function() { return EntitlementSupportPage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_redux__ = __webpack_require__("./node_modules/react-redux/es/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data_store__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/data/store.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_Main_MainContainer_jsx__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/Main/MainContainer.jsx");
...
var EntitlementSupportPage = function EntitlementSupportPage(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    __WEBPACK_IMPORTED_MODULE_1_react_redux__["a" /* Provider */],
    { store: __WEBPACK_IMPORTED_MODULE_2__data_store__["a" /* default */] },
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__components_Main_MainContainer_jsx__["a" /* default */], props)
  );
};
...
//# sourceMappingURL=EntitlementSupportPage.js.map