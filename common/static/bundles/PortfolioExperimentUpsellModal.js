(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([8],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PortfolioExperimentUpsellModal", function() { return PortfolioExperimentUpsellModal; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__("./node_modules/react/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
...
var PortfolioExperimentUpsellModal = function (_React$Component) {
    _inherits(PortfolioExperimentUpsellModal, _React$Component);

    function PortfolioExperimentUpsellModal(props) {
        _classCallCheck(this, PortfolioExperimentUpsellModal);

        var _this = _possibleConstructorReturn(this, (PortfolioExperimentUpsellModal.__proto__ || Object.getPrototypeOf(PortfolioExperimentUpsellModal)).call(this, props));

        _this.state = { isOpen: true };
        return _this;
    }

    _createClass(PortfolioExperimentUpsellModal, [{
        key: 'render',
        value: function render() {
            var slides = [__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'portfolio-slide-0' },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'p',
                ...
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                    'div',
                    { className: 'checkmark-group-header' },
            ...
            var body = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                null,
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__ExperimentalCarousel_jsx__["a" /* default */], { id: 'portfolio-upsell-modal', slides: slides }),
    ...
    return PortfolioExperimentUpsellModal;
}(__WEBPACK_IMPORTED_MODULE_0_react___default.a.Component);
...
//# sourceMappingURL=PortfolioExperimentUpsellModal.js.map